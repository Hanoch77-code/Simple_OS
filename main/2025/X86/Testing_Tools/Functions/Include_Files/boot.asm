...
mov bx,the_secret  ; sending data to the function using a common transfer register.
call my_func	   ; this is already defined in the file "file.asm"

jmp $

%include "file.asm" ; This is how to include external program assembly files when working with multiple file structre type programming
		    ; This just replaces the this line with the whole file.asm content and create a file while assembling everything
